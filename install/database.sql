...
CREATE TABLE IF NOT EXISTS `keys` (
  ...
  `ip_addresses` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `live_tv` (
  ...
  `poster` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `thumbnail` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `live_tv_category` (
  ...
  `live_tv_category_desc` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `live_tv_program_guide` (
  ...
  `video_url` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `date` date NOT NULL,
  `time` time NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plan` (
  ...
  `screens` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `slider` (
  ...
  `action_url` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `star` (
  ...
  `star_desc` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `subtitle` (
  ...
  `src` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `deactivate_reason` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `videos` (
  ...
  `trailler_youtube_source` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `enable_download` int(5) DEFAULT 1,
  `focus_keyword` mediumtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `episode_download_link` (
  ...
  `videos_id` int(11) DEFAULT NULL,
  `season_id` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_title` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `resolution` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '720p',
  `file_size` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00MB',
